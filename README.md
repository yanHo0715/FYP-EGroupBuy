...
View real-time group buy progress and remaining time
...
Create and manage group packages and bundled items

Monitor sales and group buy progress

Update order statuses (processing, shipped, cancelled)
...
Monitor all orders and group buy events

Approve or reject withdrawal requests

Finalise delivery status after shipment

Automation

Automatic group buy ending

Automatic threshold checking

Automatic refunds for failed group buys

Fair allocation logic for group packages
...
Deployment: Ubuntu (tested locally and via containers)
